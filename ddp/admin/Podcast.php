...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['eliminar_id'])) {
    try {
        ...
        $conexion->eliminarContenido('podcast', (int) $_POST['eliminar_id']);
        $conexion->close();
              ...
              <?php foreach ($podcasts as $podcast): ?>
                <article class="podcast-card" data-filter-card data-name="<?= escaparPodcast($podcast['titulo']) ?>" data-status="<?= escaparPodcast($podcast['estado']) ?>">
                  <?php if (!empty($podcast['portada'])): ?>
                    <img class="podcast-card-cover" src="<?= escaparPodcast($podcast['portada']) ?>" alt="<?= escaparPodcast($podcast['titulo']) ?>">
                  <?php else: ?>
