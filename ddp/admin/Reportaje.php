...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['eliminar_id'])) {
    try {
        ...
        $conexion->eliminarContenido('reportaje', (int) $_POST['eliminar_id']);
        $conexion->close();
...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-chartbg" data-col="2-columns">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <?php if (!esEditor()): ?><li class=" nav-item"><a href="usuarios.php"><i class="ft-user"></i><span class="menu-title" data-i18n="">usuarios</span></a></li><?php endif; ?>
        </ul>
      </div>
    ...
    <section class="reportajes-content">
      <div class="reportajes-header"><div><span class="reportajes-eyebrow">CONTENIDO EDITORIAL</span><h1>Reportajes</h1><p>Administra los reportajes, autores y galerías de imágenes.</p></div><a class="reportajes-button" href="config/reportaje.php">+ Nuevo reportaje</a></div>
      ...
      <div class="reportajes-grid">
        <?php foreach ($reportajes as $reportaje): ?>
          ...
          <article class="reportaje-card" data-filter-card data-name="<?= escapar($reportaje['titulo']) ?>" data-status="<?= escapar($reportaje['estado']) ?>">
            <?php if ($portada !== ''): ?><img class="reportaje-cover" src="<?= escapar($portada) ?>" alt="Portada de <?= escapar($reportaje['titulo']) ?>"><?php else: ?><div class="reportaje-cover reportaje-cover-empty">Sin imagen</div><?php endif; ?>
  ...
  </div></div></div><script src="assets/js/filtros.js"></script></body></html>