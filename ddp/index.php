...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/reportajes-imagenes.css">
      ...
      <a class="navbar-brand" href="index.php">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav ml-auto">
				  ...
				  <li class="nav-item @@about__active">
                      <a class="nav-link" href="podcast.php">Podcast-videos</a>
                  </li>
				  <li class="nav-item @@about__active">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 grids5-info mt-5 reportajes-secundarios">
                    <a href="<?= $enlaceReportaje ?>" class="d-block"><img src="<?= escaparPublico($imagenReportaje) ?>" alt="<?= escaparPublico($reportaje['titulo']) ?>" class="img-fluid" style="width: 100%; height: 220px; object-fit: cover;" /></a>
                    <div class="blog-info">
...
<div class="grids-block-5 py-5">
    ...
    <section class="py-lg-4 py-md-3">
        <div class="container">
            <div class="row">
                <?php foreach (array_slice($noticiasPublicas, 0, 6) as $noticia): ?>
                <?php
                ...
                <div class="col-lg-4 col-md-6 grids5-info">
                    <a target="_blank" href="<?= escaparPublico($enlaceNoticia) ?>" class="d-block"><img src="<?= escaparPublico(rutaImagenPublica($noticia['foto'], 'assets/images/blog.jpg')) ?>" alt="<?= escaparPublico($noticia['titulo']) ?>" class="img-fluid" style="width: 100%; height: 220px; object-fit: cover;" /></a>
                    <div class="blog-info">
    ...
    <div class="container py-lg-5 py-4">
        <div class="row">
            <div class="col-lg-8 align-self">
                ...
                ?>
                <?php if ($tituloBoletinReciente !== ''): ?><h3 class="title-big mb-4"><?= escaparPublico($tituloBoletinReciente) ?></h3><?php endif; ?>
                <p class=""><?= nl2br(escaparPublico($resumenBoletinReciente !== '' ? $resumenBoletinReciente : 'No hay boletines publicados.')) ?></p>
                ...
                <div class="row mt-sm-4 mt-2 px-3">
                    ...
                    <div class="col-6 p-0">
                        <span><a target="_blank" href="<?= escaparPublico(rutaImagenPublica($boletinReciente['archivo_pdf'] ?? '', '#')) ?>" class="facebook" aria-label="Descargar boletín"><i class="bi bi-download" aria-hidden="true"></i></a></span>
                        <h4><a target="_blank" href="<?= escaparPublico(rutaImagenPublica($boletinReciente['archivo_pdf'] ?? '', '#')) ?>">Ver boletín <i ></i></a></h4>
                    </div>
					<center><a href="boletines.php" class="btn btn-style btn-primary mt-md-5 mt-4">Ver todos</a></center>
                </div>
            </div>
            <div class="col-lg-4 mt-lg-0 mt-4">
                <img src="<?= escaparPublico(rutaImagenPublica($boletinReciente['foto_portada'] ?? '', 'assets/images/boletin-ntep-45.png')) ?>" class="img-fluid radius-image" alt="">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container py-lg-5 py-md-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="area-box">
                    <img src="<?= escaparPublico(rutaImagenPublica($podcast['portada'] ?? '', 'assets/images/podcast.png')) ?>" alt="<?= escaparPublico($podcast['titulo']) ?>" class="img-fluid" style="width: 100%; height: 160px; object-fit: cover; border-radius: 12px;">
