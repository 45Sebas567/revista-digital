        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 grids5-info mt-5 reportajes-secundarios">
                    <a href="<?= $enlace ?>" class="d-block"><img src="<?= escaparReportajePublico($imagen) ?>" alt="<?= escaparReportajePublico($reportaje['titulo']) ?>" class="img-fluid" style="width: 100%; height: 220px; object-fit: cover;" /></a>
                    <div class="blog-info">
